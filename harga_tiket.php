...
<html lang="en">
    <head>
        ...
        <title>Bus AKAP | Harga Tiket</title>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="harga_tiket.php">Harga Tiket <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <?php
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <?php
                                ...
                                //jika tidak, akan membuka hal web grafik_saya.php
                                else {
        ...
        <div class="container">
            <br>
            <h3 class="text-center mb-0">HARGA</h3>
                ...
                <div class="col-lg-8 mx-auto">
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <b>
                                    <th>Kelas Bus</th><th>Harga Tiket</th>
                                </b>
                            </tr>
                        </thead>
                        <tbody>
                        <?php
                            //fungsi untuk merubah angka menjadi bentuk rupiah
                        ...
                        ?>
                            <tr>
                                <td>Bus <?php echo $value['kelas_bus'];?></th>
                                <td><?php echo rupiah($value['harga_bus']);?></th>
                            </tr>
                        <?php
                            }
                        ?>
